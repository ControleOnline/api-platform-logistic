---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-logistic, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-logistic`.
...
- Checkout local: `api-community/modules/controleonline/logistic`

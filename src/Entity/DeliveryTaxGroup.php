 ...
 * @ORM\Entity (repositoryClass="ControleOnline\Repository\DeliveryTaxGroupRepository")
 */
#[ApiResource(
    operations: [
...
class DeliveryTaxGroup
{
    ...
    /**
     * @var \Collection
     * @ORM\OneToMany (targetEntity="ControleOnline\Entity\DeliveryTax", mappedBy="groupTax")
     ...
     * @return people
     */
    public function setCarrier(\ControleOnline\Entity\People $people = null)
    {
        $this->carrier = $people;
        return $this;
    }

...
class DeliveryTax
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\DeliveryRegion")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \ControleOnline\Entity\DeliveryTaxGroup
     *
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\DeliveryTaxGroup", inversedBy="deliveryTaxes")
     * @ORM\JoinColumns({
     ...
     * Set region_origin
     *
     * @param \ControleOnline\Entity\DeliveryRegion $region_origin
     * @return DeliveryTax
     */
    public function setRegionOrigin(\ControleOnline\Entity\DeliveryRegion $region_origin = null)
    {
     ...
     *
     * @param \ControleOnline\Entity\DeliveryRegion $region_destination
     * @return DeliveryTax
     */
    public function setRegionDestination(\ControleOnline\Entity\DeliveryRegion $region_destination = null)
    {
     ...
     * Get group_tax
     *
     * @return \ControleOnline\Entity\DeliveryTaxGroup
     */
     ...
     * Set group_tax
     *
     * @param \ControleOnline\Entity\DeliveryTaxGroup $group_tax
     * @return DeliveryTax
     */
    public function setGroupTax(\ControleOnline\Entity\DeliveryTaxGroup $group_tax = null)
    {

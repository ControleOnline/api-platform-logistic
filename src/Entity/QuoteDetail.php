...
class QuoteDetail
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\Quotation", inversedBy="quote_detail")
     * @ORM\JoinColumns({
    ...
    private $tax_subtype;
    /**
     * @var \ControleOnline\Entity\DeliveryTax
     *
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\DeliveryTax")
     * @ORM\JoinColumns({
     ...
     * Set delivery_tax
     *
     * @param \ControleOnline\Entity\DeliveryTax $delivery_tax
     * @return QuoteDetail
     */
    public function setDeliveryTax(\ControleOnline\Entity\DeliveryTax $delivery_tax = null)
    {
     ...
     * Get delivery_tax
     *
     * @return \ControleOnline\Entity\DeliveryTax
     */

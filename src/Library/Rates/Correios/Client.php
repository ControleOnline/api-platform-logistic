...
namespace ControleOnline\Library\Rates\Correios;

use FlyingLuscas\Correios\Client as CorreiosClient;
use FlyingLuscas\Correios\Service;

use ControleOnline\Library\Rates\Exception\ClientRequestException;
use ControleOnline\Library\Rates\CarrierRatesInterface;
use ControleOnline\Library\Rates\Model\User;
use ControleOnline\Library\Rates\Model\Quotation;
use ControleOnline\Library\Rates\Model\Rate;
